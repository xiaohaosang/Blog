...
from blog.blueprints.ajax import ajax_bp
from blog.blueprints.auth import auth_bp
from blog.blueprints.main import main_bp
from blog.blueprints.user import user_bp
from blog.extensions import bootstrap, db, login_manager, mail, dropzone, moment, whooshee, avatars, csrf, ckeditor
from blog.models import Role, User, Tag, Follow, Comment, Article
...
def register_shell_context(app):
    ...
    def make_shell_context():
        return dict(db=db, User=User, Photo=Article, Tag=Tag,
...
def register_commands(app):
    ...
    # @click.option('--category', default=20, help='Quantity of categories, default is 30.')
    @click.option('--article', default=50, help='Quantity of articles, default is 30.')
